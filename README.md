...
Standalone live dashboard tracking Google Maps + Tripadvisor reception for **Poolhouse London, Ballers Philadelphia, Ballers Boston Seaport, Five Iron Golf Dubai (Mina Seyahi + Business Bay)**. Headless Playwright scrapes every 30 minutes; Flask serves a self-contained HTML page with a 5-minute auto-reload.
