...
VENUE_TARGETS = [
    ...
    {"key": "dubai_bb",       "type": "google",
     "url": "https://www.google.com/maps/search/Five+Iron+Golf+Business+Bay+Damac+Towers+Dubai",
     "search_q":     "Five Iron Golf Business Bay Dubai",
     "places_query": "Five Iron Golf Business Bay Damac Towers by Paramount Dubai"},
]
...
def _build_dashboard_data(scrape: dict) -> dict:
    ...
    dubai_bb_g = scrape.get("dubai_bb") or {}
    ...
    dubai_bb_reviews = merge(dubai_bb_g)
    ...
    return {
        ...
        "venues": {
            ...
            "dubai_bb": {
                "google": {"rating": dubai_bb_g.get("rating"), "count": dubai_bb_g.get("count")},
                "distribution": gdist(dubai_bb_g),
                "reviews": dubai_bb_reviews,
                "analytics": _venue_analytics(dubai_bb_reviews),
                "insight": f"{dubai_bb_g.get('count','?')} Google reviews · second Dubai venue, near DIFC and the Burj",
            },
        },
    }
